...
import VideoPopup from "../../../components/videoPop/VideoPopup.jsx";
...
const DetailsBanner = ({ video, crew }) => {
  ...
  let _genres = [];
  if (data && data?.genres) {
    _genres = data?.genres.map((g) => g.id);
  }

  const directore = crew?.filter((f) => f.job === "Director");
